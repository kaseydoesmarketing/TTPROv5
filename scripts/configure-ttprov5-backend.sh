...
echo "🚀 TTPROv5 BACKEND CONFIGURATION GUIDE"
echo "======================================"
echo ""
...
echo "GOOGLE_CLIENT_ID=618794070994-70oauf1olrgmqvg284mpj5u2lf75jl1q.apps.googleusercontent.com"
echo "GOOGLE_CLIENT_SECRET=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"
echo "GOOGLE_API_KEY=AIzaSyA8hjvKfC_D1rQqIWgjhxq-xM1cmgDB3z4"
echo ""
echo "# JWT Secret"
echo "JWT_SECRET_KEY=bB9uYvA4X7cP3fN2rL6mQ8tH1jR5wK0zS5dM7pV9qT2yU8gE1cL0bF4nJ6rQ2aW7"
echo ""
...
echo "===================="
echo "1. Go to Render Dashboard → Your new TTPROv5 backend service"
echo "2. Settings → Environment Variables → Add all variables above"
echo "3. Settings → Secret Files → Add firebase-key.json with Firebase service account"
echo "4. Deploy → Connect repository → Branch: fix/ttprov5-backend-redeploy-20250810_121500"
